...
| 08 | [`08__Content_Projection_Reusable_Panel_Shell`](https://github.com/abhis3k-das/daily-angular/tree/08__Content_Projection_Reusable_Panel_Shell) | [08 - Content Projection: Reusable Panel Shell](https://app.notion.com/p/3c7498bf03a1810cbe0bd75d75172184?pvs=204) | A reusable panel shell covering named `ng-content` areas for headers, body content, and actions while keeping layout ownership separate from consumer-provided content. |
| 09 | [`09__signal_Counter_with_History`](https://github.com/abhis3k-das/daily-angular/tree/09__signal_Counter_with_History) | [09 - signal() Counter with History](https://app.notion.com/p/09-signal-Counter-with-History-3c7498bf03a18169ab0cec5bdb59cf82) | ✅ Completed — A signal-based counter covering immutable state updates, increment and decrement controls, reset behavior, and a reactive history of counter values. |
| 10 | [`10__computed_Remove_Duplicated_Derived_State`](https://github.com/abhis3k-das/daily-angular/tree/10__computed_Remove_Duplicated_Derived_State) | [10 - computed(): Remove Duplicated Derived State](https://app.notion.com/p/10-computed-Remove-Duplicated-Derived-State-3c7498bf03a181b6a726e51f2ca7ec7b) | ✅ Completed — An Angular signals exercise using `computed()` to derive values from source state, eliminating duplicated derived state and keeping dependent values automatically synchronized. |
| 11 | [`11__effect_Side_Effect_Boundary_Loop_Bug`](https://github.com/abhis3k-das/daily-angular/tree/11__effect_Side_Effect_Boundary_Loop_Bug) | [11 - effect(): Side Effect Boundary & Loop Bug](https://app.notion.com/p/11-effect-Side-Effect-Boundary-Loop-Bug-3c7498bf03a181718df6f530fd725cf6) | An Angular signals exercise using `effect()` for side effects such as local-storage synchronization and logging while keeping reactive state updates outside the effect boundary to avoid loops. |
| 12 | [`12__linkedSignal_Dependent_Selection_Reset`](https://github.com/abhis3k-das/daily-angular/tree/12__linkedSignal_Dependent_Selection_Reset) | [12 - linkedSignal(): Dependent Selection Reset](https://app.notion.com/p/12-linkedSignal-Dependent-Selection-Reset-3c7498bf03a18100af24e5ca9780d660) | An Angular signals exercise using `linkedSignal()` to keep dependent selections synchronized and reset them when their source selection changes. |
